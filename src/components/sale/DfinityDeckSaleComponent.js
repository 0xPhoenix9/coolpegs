          ...
          >
            {whitelist ? (
              ...
              <Grid className={classes.stat} item md={3} xs={6}>
                ...
                <br />
                <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                  {salePrice !== false ? _showListingPrice(salePrice) + ' ICP' : 'Loading...'}
                </span>
              </Grid>
            )}
            <Grid className={classes.stat} item md={3} xs={6}>
            ...
            <Grid className={classes.stat} item md={3} xs={6}>
              ...
              <br />
              <span style={{fontWeight: 'bold', color: 'rgb(225 142 19)', fontSize: '2em'}}>
                {pending !== false ? pending : 'Loading...'}
              </span>
            </Grid>
            <Grid className={classes.stat} item md={3} xs={6}>
              <strong>SOLD</strong>
            ...
            <Grid className={classes.stat} item xs={10}>
              <LinearProgress
                ...
                valueBuffer={Math.round(((remaining + pending) / totalToSell) * 100)}
              />
            </Grid>
          </Grid>
          <br />
                  ...
                  {remaining > 0 ? (
                          ...
                          <p>
                            <strong>
                              <span style={{fontSize: '20px', color: 'black'}}>
                                You are on the whitelist! The private sale starts{' '}
                          ...
                          <>
                            ...
                            >
                              <Grid justifyContent="center" item md={6} xs={12}>
                                ...
                                >
                                  <img
                                    src="/dfinity_deck/images/wl_mint.png"
                                    style={{width: '100%'}}
                                  ></img>
                                </Button>
                              </Grid>
                              <Grid justifyContent="center" item md={6} xs={12}>
                                <img
                                  src="/dfinity_deck/images/parchment.png"
                                  style={{width: '100%'}}
                                ></img>
                              </Grid>
                            </Grid>
                            <p>
                              <strong>Please note:</strong> All transactions are secured via
                              Entrepot's escrow platform. There are no refunds or returns, once a
                              transaction is made it can not be reversed. Entrepot provides a
                              transaction service only. By clicking one of the buttons above you
                              show acceptance of our{' '}
                              <a
                        ...
                        <>
                          ...
                          >
                            <Grid justifyContent="center" item md={6} xs={12}>
                              ...
                              >
                                <img
                                  src="/dfinity_deck/images/regular_mint.png"
                                  style={{width: '100%'}}
                                ></img>
                              </Button>
                            </Grid>
                          ...
                          <p>
                            ...
                            Entrepot's escrow platform. There are no refunds or returns, once a
                            transaction is made it can not be reversed. Entrepot provides a
                            transaction service only. By clicking one of the buttons above you show
                            acceptance of our{' '}
                            <a
                              href="https://docs.google.com/document/d/13aj8of_UXdByGoFdMEbbIyltXMn0TXHiUie2jO-qnNk/edit"
                              target="_blank"
                          ...
                          <p>
                            <strong>
                              <span style={{fontSize: '20px', color: 'black'}}>
                                ...
                                <Timestamp relative autoUpdate date={whitelistTime / 1000} />!
                              </span>
                            </strong>
                          </p>
                        </>
                    ...
                    <>
                      <p>
                        <strong>
                          <span style={{fontSize: '20px', color: 'black'}}>
                            There are currently no more NFTs available, but not all sales have
                            settled yet. If these transactions do not settle in time, the NFTs will
                            become available to purchase again.
                          </span>
                        </strong>
                      </p>
                    </>
                  ...
                  <p>
                    <strong>
                      <span style={{fontSize: '20px', color: 'red'}}>
                        Sorry, the sale is now over! You can grab your NFT from the marketplace!
                      </span>
                    </strong>
                  </p>
                  <Button
